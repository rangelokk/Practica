...
def main(args=None):
    """
    print("начало requirements.txt")
    print("numpy " + str(np.__version__))
    print("rclpy " + str(rclpy.__version__))
    print("rclpy.node " + str(rclpy.node.__version__))
    print("cv2 " + str(cv2.__version__))
    print("sensor_msgs.msg" + str(sensor_msgs.msg.__version__))
    print("std_msgs.msg" + str(std_msgs.msg.__version__))
    print("message_filters" + str(smessage_filters.__version__))
    print("rclpy.qos" + str(rclpy.qos.__version__))
    print("sensor_msgs_py" + str(sensor_msgs_py.__version__))
    print("cv_bridge" + str(cv_bridge.__version__))
    print("open3d" + str(open3d.__version__))
    print("ctypes" + str(ctypes.__version__))
    print("конец requirements.txt")
